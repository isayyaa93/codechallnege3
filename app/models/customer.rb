...
# creates a new review for the restaurant with the given restaurant_id
    ...
    def add_review(restaurant, rating)
        Review.create(star_rating: rating, restaurant_id: restaurant.id, customer_id: self )
    end
    ...
    def delete_reviews(restaurant)
        ...
        # Restaurant.all.find(restaurant).delete_all(:restaurant)
        # Restaurant.all.find(restaurant.id)
